...
**Obsidian Contexts** allows you to save your current workspace (open tabs) as a "Context" and switch between them seamlessly.

**Contexts** supports **all file types** including **PDFs, Canvases, Images, and Markdown notes**.
...
2. Create a folder named `obsidian-contexts` inside your vault's plugin folder: `.obsidian/plugins/`.
